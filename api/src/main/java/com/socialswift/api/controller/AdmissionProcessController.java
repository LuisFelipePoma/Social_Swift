...
public class AdmissionProcessController {
    ...
    public ResponseEntity<AdmissionProcessResponseDTO> rejectAdmissionProcess(@PathVariable Long id) {
        AdmissionProcessResponseDTO admission = admissionProcessService.rejectAdmissionProcess(id);
        return new ResponseEntity<>(admission, HttpStatus.OK);
    }
}
